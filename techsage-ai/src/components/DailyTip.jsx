...
// Picks a tip based on day-of-year so it changes daily but is stable within a day
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px', flexWrap: 'wrap' }}>
            <span style={{
              background: grad, borderRadius: RADIUS.full,
              padding: '3px 10px', fontSize: '11px',
              fontFamily: FONT.heading, fontWeight: '800', color: '#fff',
          ...
          <p style={{ fontFamily: FONT.heading, fontSize: `${fontSize}px`, fontWeight: '900', color: '#78350F', lineHeight: 1.3 }}>
            {tip.title}
          </p>
        </div>
        <span style={{ fontSize: '20px', color: C.muted, flexShrink: 0, transition: 'transform 0.3s', transform: expanded ? 'rotate(180deg)' : 'rotate(0deg)' }}>▾</span>
      </button>
      ...
      {expanded && (
        <div style={{
          padding: '0 24px 24px',
          borderTop: `1px solid ${C.amber}25`,
        }}>
          <div style={{
            background: 'rgba(255,255,255,0.65)', borderRadius: RADIUS.md,
            padding: '18px 20px', marginTop: '16px',
            boxShadow: 'inset 4px 4px 8px rgba(217,119,6,0.08)',
          }}>
            <p style={{ fontSize: `${fontSize}px`, color: '#78350F', lineHeight: 1.85, fontWeight: '500' }}>
              {tip.tip}
            </p>
          </div>
          {tip.source && (
            <p style={{ fontSize: `${fontSize - 5}px`, color: C.muted, marginTop: '10px', fontFamily: FONT.heading, fontWeight: '700' }}>
              Source: {tip.source}
            </p>
          )}
        </div>
